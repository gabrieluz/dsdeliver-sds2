...
export default function OrderDetails({route} : Props) {
  ...
  const handleOnPressConfirmDelivery = () =>{
  ...
  return (
    ...
    <View style={styles.container} >
      ...
      <RectButton style={styles.button} onPress={handleOnPressConfirmDelivery} >
        <Text style={styles.buttonText} >CONFIRMAR ENTREGA</Text>
      </RectButton>
      <RectButton style={styles.button} onPress={handleOnPressCancel} >
